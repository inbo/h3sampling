...
/// @noRd
#[extendr]
pub fn h3_coverage(wkb_bytes: &[u8], res: i32, containment: &str) -> extendr_api::Result<Vec<u8>> {
...
// ---------------------------------------------------------------------------
// extendr module registration for the `grts_h3` submodule
// ---------------------------------------------------------------------------
